...
Para experimentação prática, desenvolvi este projeto: [[https://github.com/lobovit/zInputs][https://github.com/lobovit/zInputs]] - uma API de interceptação para dispositivos de entrada.
