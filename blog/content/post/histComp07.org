...
Durante décadas, a lei de [[https://pt.wikipedia.org/wiki/Lei_de_Moore][Moore]] e o aumento da frequência do relógio foram a receita mágica do progresso: a cada nova geração, processadores rodavam mais rápido e programas antigos simplesmente aceleravam sem precisar de modificação.
...
/Fonte:/ [[https://a.co/d/0a3DsSsn][Code: The Hidden Language of Computer Hardware and Software]], 2ª ed., Charles Petzold<br>
[[https://csapp.cs.cmu.edu][Computer Systems: A Programmer's Perspective]], 2ª ed., Randal E. Bryant e David R. O'Hallaron
