...
No Rama, os datastores indexados são chamados de [[https://docs.redplanetlabs.com/concepts/pstates.html][PStates]] ("partitioned state"). Ao contrário de bancos de dados tradicionais com modelos fixos, os PStates permitem infinitos modelos de dados através da composição de estruturas simples:
...
Este [[https://docs.redplanetlabs.com/concepts/pstates.html][PState]] representa uma árvore genealógica onde cada pessoa é identificada por um UUID e possui campos para seus pais, nome e filhos.
