...
A resposta é a /[[https://pt.wikipedia.org/wiki/Pilha_(inform%C3%A1tica][Pilha]]) (Stack)/, uma estrutura LIFO (/Last-In-First-Out/) mantida na RAM, gerenciada por um registrador especial chamado /[[https://en.wikipedia.org/wiki/Stack_register][Stack Pointer]]/ (SP).
