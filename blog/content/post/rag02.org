...
Como muitos desenvolvedores já descobriram, criar um protótipo funcional de [[https://en.wikipedia.org/wiki/Retrieval-augmented_generation][RAG]] com alguns documentos é relativamente simples. O verdadeiro desafio começa quando precisamos escalar esse sistema para lidar com milhares de documentos, garantir respostas precisas e manter o desempenho sob carga. Neste artigo, vamos explorar técnicas avançadas para superar esses desafios e levar nosso [[https://github.com/lobovit/docai][DocAI]] para um novo patamar de qualidade e confiabilidade.
...
Baseado na nossa experiência com o [[https://github.com/lobovit/docai][DocAI]] e nos desafios relatados pela comunidade, identificamos quatro armadilhas principais que podem comprometer sistemas RAG:
...
#+BEGIN_QUOTE
Caso não saiba o que é o DocAI, você pode ver os artigos anteriores [[https://lobovit.github.io/2025/03/23/rag/][RAG Simples com Clojure e Ollama]] e [[https://lobovit.github.io/2025/03/25/semantic-postgresql/][Busca Semântica com Ollama e PostgreSQL]].
#+END_QUOTE
...
- [[https://github.com/lobovit/docai][Projeto DocAI]] - Repositório do projeto DocAI.