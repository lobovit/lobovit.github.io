...
Nos últimos lançamentos, o Emacs evoluiu muito para desenvolvimento moderno: /[[https://en.wikipedia.org/wiki/Tree_sitter][suporte a tree-sitter]]/ (análise sintática incremental) e um /[[https://www.gnu.org/software/emacs/manual/html_node/eglot/index.html][cliente LSP nativo (Eglot)]]/ simplificam autocompletar, navegação e refatoração em várias linguagens, sem depender de plugins externos pesados.
...
![[/post/images/emacs/emacs01.png][Emacs]]
...
O Emacs assim como o [[https://www.vim.org/][Vim]], tem uma sintaxe de atalhos muito parecida, mas com algumas diferenças. Aqui estão as teclas que você precisa saber:

![[/post/images/emacs/emacs02.png][Emacs]]
...
Bastante coisa, né? Mas não se preocupe, você não precisa saber todas elas. Nem mesmo nos editores mais famosos, como o [[https://code.visualstudio.com/][VSCode]], você precisa saber todas as teclas. Você pode aprender as que mais fazem sentido para você (ou que você achar que é mais útil). 
...
Algo em torno de uma a duas semanas (será que compensa? vai vendo...). A propósito, criei este cheatsheet acima usando o [[https://excalidraw.com/][Excalidraw]].
...
Vamos supor que você queira escrever um artigo. Geralmente as pessoas escolhem escreve-lo em [[https://www.markdownguide.org/][Markdown]]. O Emacs tem um modo especial para isso, chamado [[https://orgmode.org/][Org Mode]]. 

Este modo transforma arquivos ~.org~ (isto é, em formato de texto simples) em um ambiente de escrita e organização poderoso: você captura ideias, estrutura tópicos, acompanha tarefas e exporta para [[https://orgmode.org/manual/Export-Formats.html][HTML, PDF, DOCX e mais]] — tudo em texto simples. 
...
Note que no Org Mode, você pode usar markdown, html, latex, etc. Acima usamos markdown e latex ao mesmo tempo. Todos os formatos são suportados. Veja a lista completa de formatos suportados [[https://orgmode.org/worg/org-syntax.html][aqui]].
...
Vale muito a pena investir tempo nisso. A propósito, aqui está a [[https://orgmode.org/org.pdf][documentação oficial do Org Mode]] em PDF.

-----

* Navegador nativo

Se a graça do Org Mode é /escrever e ler com foco/, o [[https://www.gnu.org/software/emacs/manual/html_node/eww/index.html][EWW]] é o passo seguinte: /pesquisar e consumir conteúdo/ sem sair do Emacs. Pense nele como um “reader mode” embutido — simples, rápido e bom o suficiente para docs, blogs e referências técnicas enquanto você codifica/escreve.

![[/post/images/emacs/eww.png][EWW]]
