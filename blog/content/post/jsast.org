...
Vale muito a pena dar uma olhada na documentação do ESTree (link lá no final) e brincar no [[https://astexplorer.net/][astexplorer.net]] pra ver como diferentes códigos viram ASTs.
...
/   /Esprima (Site Oficial):* [[http://esprima.org/][esprima.org]]
/   /ESTree (A "Gramática" das ASTs):* [[https://github.com/estree/estree][github.com/estree/estree]]
/   /AST Explorer (Seu Melhor Amigo!):* [[https://astexplorer.net/][astexplorer.net]]
/   /Estraverse (Pra Passear Melhor):* [[https://github.com/estools/estraverse][github.com/estools/estraverse]]
/   /Escodegen (Pra Gerar Código da AST):* [[https://github.com/estools/escodegen][github.com/estools/escodegen]]
/   /Acorn (Alternativa):* [[https://github.com/acornjs/acorn][github.com/acornjs/acorn]]
/   /Babel Parser (Outra Alternativa):* [[https://babeljs.io/docs/en/babel-parser][babeljs.io/docs/en/babel-parser]]
