...
Quando você atinge dezenas de milhares de transações por segundo, a pergunta mais perigosa que você pode fazer é _"qual formato de serialização devo usar?"_. Não porque a resposta seja irrelevante, mas porque ela quase nunca é o gargalo real. Esta é a história de como, durante o desenvolvimento do /[[https://github.com/lobovit/Ollanta][Ollanta]]/, uma plataforma de análise estática multilinguagem escrita em Go, eu quase caí na armadilha de otimizar o problema errado.

#+ATTR_HTML: :width 250 :alt ollanta :style display:block;margin:1em auto;
[[https://github.com/lobovit/Ollanta/raw/main/docs/imgs/logo-dark.png]]
...
- [[https://www.postgresql.org/docs/current/sql-copy.html][PostgreSQL COPY Protocol]] — bulk insert 50× mais rápido
- [[https://github.com/jackc/pgx][pgx CopyFrom]] — driver Go com suporte nativo a COPY
- [[https://www.postgresql.org/docs/current/sql-select.html#SQL-FOR-UPDATE-SHARE][PostgreSQL FOR UPDATE SKIP LOCKED]] — claim atômico para workers paralelos
- [[https://github.com/lobovit/Ollanta][Ollanta no GitHub]] — plataforma de análise estática open source
- [[https://docs.sonarsource.com/sonarqube/latest/architecture/][SonarQube Architecture]] — referência de comparação arquitetural
