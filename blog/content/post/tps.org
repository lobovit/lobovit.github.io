...
Quando você atinge dezenas de milhares de transações por segundo, a pergunta mais perigosa que você pode fazer é _"qual formato de serialização devo usar?"_. Não porque a resposta seja irrelevante, mas porque ela quase nunca é o gargalo real. Esta é a história de como, durante o desenvolvimento do /[[https://github.com/scovl/Ollanta][Ollanta]]/, uma plataforma de análise estática multilinguagem escrita em Go, eu quase caí na armadilha de otimizar o problema errado.

#+ATTR_HTML: :width 250 :alt ollanta :style display:block;margin:1em auto;
[[https://github.com/scovl/Ollanta/raw/main/docs/imgs/logo-dark.png]]
...
- [[https://github.com/scovl/Ollanta][Ollanta no GitHub]] — plataforma de análise estática open source
