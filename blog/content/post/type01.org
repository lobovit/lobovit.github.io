...
Neste artigo, discutimos como as linguagens /[[https://www.rust-lang.org/][Rust]]/ e /[[https://en.wikipedia.org/wiki/C%2B%2B][C++]]/ implementam inferência de tipos de formas fundamentalmente diferentes, analisando as consequências práticas de cada abordagem.

Exploramos também brevemente o caso do /[[https://en.wikipedia.org/wiki/Swift_(programming_language][Swift]])/, comparando sua estratégia híbrida e os desafios de desempenho que ela acarreta. Ao final, refletimos sobre o impacto dessas escolhas de design na experiência de programação.

Em linguagens de programação /[[https://en.wikipedia.org/wiki/Type_system#Static_type_checking][estaticamente tipadas]]/, como Rust e C++, cada variável e expressão possui um /tipo/ definido em tempo de compilação. O tipo especifica que espécie de dado está sendo armazenado (por exemplo, um número inteiro, um texto, um vetor de strings etc.) e determina que operações são permitidas sobre ele.
...
[[https://raw.githubusercontent.com/lobovit/lobovit.github.io/refs/heads/main/blog/content/post/images/retropc01.png]]

Linguagens modernas incorporaram inferência de tipos de formas variadas. A ideia remonta à pesquisa acadêmica dos anos 1960 e 1970 (trabalhos de /[[https://en.wikipedia.org/wiki/J._Roger_Hindley][Hindley]]/ e /[[https://en.wikipedia.org/wiki/Robin_Milner][Milner]]/, entre outros) e tornou-se um pilar em linguagens funcionais como [[https://en.wikipedia.org/wiki/ML_(programming_language][ML]]) e [[https://en.wikipedia.org/wiki/Haskell_(programming_language][Haskell]]), que conseguem inferir tipos para praticamente todas as expressões sem nenhuma anotação do programador.

Já em linguagens de uso geral como C++, a inferência de tipos foi introduzida de forma mais limitada (por exemplo, com o keyword ~auto~ em [[https://en.wikipedia.org/wiki/C%2B%2B11][C++11]]) para facilitar a sintaxe mantendo a compatibilidade com seu sistema de tipos complexo.
...
Um exemplo clássico é o tipo de uma /[[https://en.cppreference.com/w/cpp/language/lambda][lambda]]/ (função anônima) em C++: lambdas possuem tipos únicos gerados pelo compilador, sem um nome simples para o programador referenciar. 
...
O Rust adota uma estratégia de inferência de tipos /mais robusta e contextual/, inspirada no clássico algoritmo /[[https://en.wikipedia.org/wiki/Hindley%E2%80%93Milner_type_system][Hindley–Milner]]/ da teoria de tipos, mas estendida com traits, sistemas de regiões/lifetimes e outras características que o tornam distinto do HM puro. 
...
Analogamente, ~y~ é deduzido como ~Vec<String>~ porque é passado para ~bar~. Assim, /o mesmo código de inicialização resultou em dois tipos diferentes/ para as variáveis, dependendo do uso posterior de cada uma. Esse comportamento seria impossível em C++ ou Go, mas em [[https://www.rust-lang.org/][Rust]] ele é natural dentro do modelo de inferência contextual.

[[https://raw.githubusercontent.com/lobovit/lobovit.github.io/refs/heads/main/blog/content/post/images/retropc02.png]]
...
- [[https://en.cppreference.com/w/cpp/language/auto.html#:~:text=The%20type%20of%20a%20variable,initializing%20declaration%20of%20a%20variable][Placeholder type specifiers (since C++11)]] 
- [[https://danielchasehooper.com/posts/why-swift-is-slow/#:~:text=Swift%206%20spends%2042%20seconds,No%20matter%20how][Why Swift’s Type Checker Is So Slow]]
